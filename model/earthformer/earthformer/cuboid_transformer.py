...
from .utils import get_activation, get_norm_layer, _generalize_padding, _generalize_unpadding,  apply_initialization, round_to
...
class CuboidTransformerModel(nn.Module):
    ...
    def __init__(self,
                 ...
                 # dec_self_cuboid_size=[(5, 5, 4), (5, 5, 4)],
